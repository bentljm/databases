...
var app = {
  ...
  renderRoom: function(roomname) {
    ...
    var $option = $('<option/>').val(roomname).message(roomname);
  ...
  renderMessage: function(message) {
    ...
    $username.message(message.username + ': ').attr('data-roomname', message.roomname).attr('data-username', message.username).appendTo($chat);
    ...
    var $message = $('<br><span/>');
    $message.message(message.mess).appendTo($chat);
